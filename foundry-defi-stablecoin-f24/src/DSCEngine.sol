...
contract DSCEngine is ReentrancyGuard {
     ...
     * @param amountCollateral amount of tokenCollateralAddress to deposit
     ...
     * @param amountCollateral amount of tokenCollateralAddress to redeem
        ...
        external
    {
        ...
        // redeemCollateral alreadt checks for health factor.
    }
    ...
    // $75 backing $50 DSC
    // Liquidatator take $75 backing and burns off the $50 DSC

    // if someone is almost undercollateralized, we will pay you to liquidate them!

    /**
     * @param collateral The ertc20 collateral address to liquidate from the user
     ...
     * @notice This function working assumes the protocol will beroughly 200%
     * overcollateralized in order for this to work.
     * @notice A known bug whould be if the protocol were 100% or les collateralized, then
     * we wouldn't be able to incentive the liquidators.
     * For example, if the price of the collateral plummedted before anyone could be liquidated.
     *
     * Follows CEI:
        ...
        nonReentrant
    {
        ...
        // We should implement a feature to liquidate in the event of the protocol in insolvent
    ...
    function getAccountInformation(address user) external view returns (uint256 totalDscMinted, uint256 collaterValueInUsd) {
        (totalDscMinted, collaterValueInUsd) = _getAccountInformation(user);
    }
